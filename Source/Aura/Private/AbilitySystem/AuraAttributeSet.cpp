...
void UAuraAttributeSet::HandleDebuff(const FEffectProperties& Props)
{
	...
	// InheritableOwnedTagsContainer = GrantedTags
	...
	// That's crazy =D
	// I just need to create a new FGameplayModifierInfo& ModifierInfo and then Add it to Effect->Modifiers
	...
	{
		// We can pass EffectContext.Get(), it should also work
